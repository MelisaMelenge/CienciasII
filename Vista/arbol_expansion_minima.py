from PySide6.QtWidgets import (
    ...
    QPushButton, QFrame, QSpinBox, QFileDialog, QScrollArea, QTextEdit, QTabWidget, QComboBox
)
...
class ArbolExpansionMinima(QMainWindow):
    def __init__(self, cambiar_ventana):
        ...
        self.setWindowTitle("Ciencias de la Computación II - Árbol de Expansión Mínima")
        ...
        titulo = QLabel("Ciencias de la Computación II - Árbol de Expansión Mínima")
        ...
        self.visual_arbol = VisualizadorGrafo("Árbol de Expansión Mínima", parent=self, es_editable=False)
        ...
        # En la vista, modifica los estilos de los QTextEdit:
        ...
        self.tabs_resultados.addTab(self.circuitos_text, "🔄 Circuitos")
        ...
        btn_guardar_arbol = QPushButton("Guardar Árbol")
        btn_guardar_arbol.setStyleSheet("""
            QPushButton {
                background-color: #9c724a;
                color: #FFEAC5;
                padding: 8px 16px;
            ...
            QPushButton:hover { background-color: #6C4E31; }
        """)
        btn_guardar_arbol.clicked.connect(self.controller.guardar_arbol)
        ...
        btn_limpiar_resultado.setStyleSheet("""
            ...
            QPushButton:hover { background-color: #9c724a; }
        """)
        btn_limpiar_resultado.clicked.connect(self.controller.limpiar_resultado)
        ...
        """)
        btn_limpiar_todo.clicked.connect(self.controller.limpiar_todo)

        botones_extras.addWidget(btn_guardar_arbol)
